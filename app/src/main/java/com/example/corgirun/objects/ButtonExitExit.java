...
public class ButtonExitExit extends ButtonPuz {

	public ButtonExitExit(CorePuz corePuz, int x, int y) {
		super(corePuz);
		this.x = x;
		this.y = y;
		buttonOn = false;
		...
		animationButton = new AnimationButtonPuz(
				ResourceUtils.buttExitExit.get(0),
				ResourceUtils.buttExitExit.get(1)
		);
	}
